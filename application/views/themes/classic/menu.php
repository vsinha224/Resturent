...
?>
     ...
     <div class="container wow fadeIn">
         ...
         <div class="row">
             <div class="col-xl-3 col-md-4 sidebar leftSidebar">
                 ...
                 <div class="category_choose p-3 mb-3" style="display:none">
                     <h6 class="mb-3 text-center">Calender
                        <?php $getstring = $_GET; $categoryid = "";
                            if(count($getstring) > 0){
                                $getData = array_keys($getstring);
                                $categoryid = $getData[0];
                            }
                    ?>
                    </h6>
                    <?php // if($categoryid == 1 ){} ?>
 ...
 -->                    <!-- <div class="panel-group" id="accordion">
                 ...
                 <div class="sidebar_box p-2 mb-3 text-center sidebar_schedule" style="display:none">
