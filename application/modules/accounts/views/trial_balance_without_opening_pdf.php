...
<div class="row">
    <div class="col-sm-12 col-md-12">
        ...
        As On <?php echo $dtpFromDate; ?> <?php echo display('to_date');?> <?php echo $dtpToDate;?></h3></td></tr>
                <tr class="table_head">
                <td width="20%" align="center" style="border-left: solid 1px #000; border-top: solid 1px #000;"><strong><?php echo display('accounts_code');?></strong></td>
                <td width="50%" align="center" style="border-left: solid 1px #000; border-top: solid 1px #000;"><strong><?php echo display('accounts_name');?></strong></td>
                    ...
                    <table width="100%" cellpadding="1" cellspacing="20" style="margin-top: 50px">
                      <tr>
                          <td width="20%" style="border-top: solid 1px #000;" align="center"><?php echo display('prepared_by') ?></td>
                            <td width="20%" style="border-top: solid 1px #000;" align="center"><?php echo display('ac_office') ?></td>
