...
//approved
 ...
 //Trial Balance Report 
	...
	public  function get_vouchar_view2($id){
        $sql="SELECT acc_transaction.VNo,acc_transaction.Vtype,acc_transaction.VDate,acc_transaction.COAID,SUM(acc_transaction.Debit) AS Amount,SUM(acc_transaction.Credit) AS Amount, acc_coa.HeadName FROM acc_transaction Left JOIN acc_coa ON acc_coa.HeadCode=acc_transaction.COAID WHERE acc_transaction.VNo='$id' ORDER BY acc_coa.HeadName";
        $query = $this->db->query($sql);
        return $query->result();
    }
